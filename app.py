...
def download_model():
    ...
    # 下载数据库
    download(model_repo='RangeKing/openmmlab-docs', output='./')
    os.system('unzip data_base_openmmlab.zip')
...
def load_chain():
    ...
    # 向量数据库持久化路径
    persist_directory = 'data_base_openmmlab/vector_db/chroma'
...
if __name__ == "__main__":
    ...
    with block as demo:
        ...
        gr.Markdown("""提醒：<br>
        1. 本助手使用的是 InternLM 7B 模型和 Langchain 搭建，为 OpenMMLab 系列仓库文档助手。
